...
namespace RaycastPro.Editor
{
    ...
    public static class IconManager
    {
        ...
        public static Texture2D Header => AssetDatabase.LoadAssetAtPath<Texture2D>(RCProPanel.ResourcePath + "/RaycastPro_Header.png");
        ...
        public static IEnumerable<Texture2D> GetResources()
        {
            ...
            foreach (var guid in TextureGUIDS)
            {
                ...
                if (texture == null)
                {
                    Debug.LogWarning($"[IconManager] Failed to load texture at path: {texturePath}");
                    continue;
                }
